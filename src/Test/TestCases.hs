...
strofoidSymbolic pols
    | (show $ characteristicWuSetSym pols [] 0) == "[(-1cde) X_0 X_1^2 + (1aee+-1bde) X_1^2 + (-1cef) X_0 + (-1bef),(1ccdddee) X_1^6 + (1aaeeeee+-2abdeeee+1bbddeee+3ccddeef) X_1^4 + (-2abeeeef+2bbdeeef+3ccdeeff) X_1^2 + (1bbeeeff+1cceefff)uu]" = putStrLn "strofoidSymbolic SUCCESSFUL"
